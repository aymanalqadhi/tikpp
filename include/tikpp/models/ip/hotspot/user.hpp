 ...
 */
struct user : tikpp::data::disableable_model {
     ...
     * one-to-one NAT translations. Address does not restrict HotSpot login only
     * from this address
     */
    ...
    /*!
     * \brief HotSpot client's e-mail, informational value for the HotSpot user.
     */
     ...
     *
     * Maximal amount of bytes that can be received from the user User is
     * disconnected from HotSpot after the limit is reached.
     */
